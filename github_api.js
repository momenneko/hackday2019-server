...
// get repositories
function getRepositoriesFromUsername(username){ // e.g. octocat
    // mock responce
    ...
    return repo_obj[0].full_name // -> octcat
...
console.log(getRepositoriesFromUsername("sample"))
console.log(getLanguagesFromUserInfo("sample/testrepo"))